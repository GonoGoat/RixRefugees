...
insert into users (password,fname,lname,mail,isAdmin,isActive,lastActivity,contact,token,expireToken)
    values ('test123','Marc','Deville','marc.deville54@outlook.fr',true,true,now(),'','a',current_date),('test123','Gauthier','Verschraegen','gauth.vrsgn@outlook.be',false,true,now(),'','a',current_date),
    ('test123','Claude','Masson','c.masson@ephec.be',true,true,now(),'','a',current_date),('test123','Lucas','Pastori','lucas.pastori@gmail.com',true,true,now(),'','a',current_date);
